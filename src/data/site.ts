...
export const site: SiteConfig = {
  ...
  purpose: "Die Seite bietet gepflegte SEO Agent Skill Packs, einen einfachen Skill Generator, einen lokalen formatspezifischen Skill Check mit Fix-Blöcken, einen Policy Generator und reproduzierbare Aufgaben als belastbare Arbeitsgrundlage.",
  ...
  boundary: "Crawl Foundry darf keinen automatischen Siegerstatus erhalten. Jede spätere Bewertung braucht datierte Testevidenz und eine Eigentumsoffenlegung.",
  primaryProject: "Crawl Foundry (akzeptiert)",
  ownershipDisclosure: "seo-ai-agent.de wird im Umfeld von Crawl Foundry betrieben. Crawl Foundry ist eine offengelegte eigene Produktoption, keine unabhängige Quelle und erhält keinen automatischen Siegerstatus.",
  indexing: "indexable",
  ...
  pages: [
    ...
    { path: "/seo-agent-skill-check", label: "SEO Agent Skill Checker", description: "SKILL.md, Cursor Rules und Prompts lokal mit formatspezifischen Regeln prüfen, reparieren und als SHA-256-QA-Report dokumentieren.", indexableWhenLaunched: true },
    ...
    { path: "/en/seo-agent-skill-check", label: "SEO Agent Skill Checker", description: "Review and repair SKILL.md files, Cursor Rules, and prompts locally with format-specific rules and a SHA-256 QA report.", indexableWhenLaunched: true },
