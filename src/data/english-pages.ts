...
export const englishPages: readonly EnglishPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { number: "03 / LOCAL TOOLS", title: "Browser-local generators", paragraphs: ["Inputs in the SEO Agent Skill Generator, Skill Packager, Policy Generator, and SEO Agent Cost Calculator are processed in browser memory only. They are not sent to seo-ai-agent.de, Contextter, Vercel Functions, an MCP server, or an external API. Clipboard access occurs only after an explicit copy action.", "The Skill Packager also creates its individual files and ZIP packages on your device from statically delivered templates. There is no upload, model call, or server-side generation step."] },
