...
export const englishPages: readonly EnglishPage[] = [
  ...
  {
    slug: "privacy", title: "Privacy", description: "Privacy information for the static Vercel website and its browser-local generators.", intro: "What this website processes — and what remains local.", meta: "GDPR / UPDATED 29 AUGUST 2026", legal: true,
    sections: [
      ...
      { number: "03 / LOCAL TOOLS", title: "Browser-local generators", paragraphs: ["Inputs in the SEO Agent Skill Generator, Skill Packager, Skill Check, Policy Generator, and SEO Agent Cost Calculator are processed in browser memory only. They are not sent to seo-ai-agent.de, Crawl Foundry, Vercel Functions, an MCP server, or an external API. Clipboard access occurs only after an explicit copy action.", "The Skill Packager creates its individual files and ZIP packages, while the Skill Check creates fix blocks and its Markdown QA report on your device from statically delivered templates and rules. The report's SHA-256 input hash is computed through your browser's Web Crypto API. There is no upload, model call, or server-side generation step."] },
